            ...
            <table class="table table-bordered" id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="?page=<?= $_GET['page'] ?>&function=insert&product_id=<?php echo $objResult["product_id"];?>&act=add">เพิ่มลงรายการ</a></td>
                    </tr>
                    <?php
  }
  ?>
...
if(!empty($_SESSION['cart']))
{
	...
	foreach($_SESSION['cart'] as $product_id=>$product_quantity)
	{
		...
		echo "<td width='120' align='center'><a class='btn btn-danger' href='?page=phase&function=insert&product_id=$product_id&act=remove'>ลบรายการ</a></td>";
		echo "</tr>";
	}
	echo "<tr>";
...
?>
                <tr>
                    <td colspan="5" align="right">
                        ...
                        <input class="btn btn-success btn-rounded" value="รายการสรุปใบสั่งซื้อ"
