...
//     $timesend = date('Y-m-d H:i:s', strtotime("tomorrow 08:00:00")) ;
//     $timenow = date('Y-m-d H:i:s' ,strtotime("-1 house",strtotime($timesend)));
// if($timesend  $timenow)
...
switch ($case_notify) {
    case 5:
        $sMessage =  "".$row['product_name']." สินค้าเมื่อหมดอายุ";
        break;
    case 4:
        $sMessage = "".$row['product_name']." สินค้าชิ้นนี้จะหมดอายุในอีก 30 วัน";
        break;
    case 3:
        $sMessage = "".$row['product_name']." สินค้าชิ้นนี้จะหมดอายุในอีก 15 วัน ";
        break;
    case 2:
        $sMessage = "".$row['product_name']." สินค้าชิ้นนี้จะหมดอายุในอีก 7 วัน ";
        break;
    default:
        $sMessage = "".$row['product_name']." สินค้าชิ้นนี้ยังไม่หมดอายุ";
        break;
}
// $sMessage = 'sasadad'; 
