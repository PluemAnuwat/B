...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2022 at 10:57 AM
...
CREATE TABLE `customer` (
  ...
  `customer_drug` varchar(255) DEFAULT NULL,
  `customer_his` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `customer_last`, `customer_phone`, `customer_drug`, `customer_his`) VALUES
(25, 'รัตนพร ', 'แดงวัน', '0641318526', '-', NULL),
(26, 'อนุวัฒน์', 'จันทร์รัศมี', '0677455621', '-', NULL);
...
CREATE TABLE `customer_history` (
  `customer_his_id` int(10) NOT NULL,
  `customer_id` varchar(300) NOT NULL,
  `customer_history` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(6778001, 'ei', '12345', 'เภสัชกร', NULL, 'PharmactDachaiV2', 'PharmactDachai@gmail.com', '0641318525'),
(61122421, 'manager', '12345', 'เจ้าของกิจการ', 'logo.png', 'อภิวัฒน์ เจริญธรรม', 'aphiwat@gmail.co.th', '0645519578'),
(61122422, 'admin', '1234', 'ผู้ดูแลระบบ', '300864147_482594050346482_7489829925364306286_n.jpg', 'admin', 'admin@gmail.com', '0667888182');
...
(172, 'Zs3F6QEwxw', '2022-09-26', 'ei', '1', ''),
(173, 'vWhlTmVAIh', '2022-09-26', 'ei', '1', ''),
(174, 'vWhlTmVAIh', '2022-09-26', 'ei', '1', '');
...
(136, '154', NULL, NULL, '1', '158', 'PO-0o68ekrmb7ux', 214, '172'),
(137, '156', NULL, NULL, '30', '159', 'PO-avbr9dik5917', 482, '173'),
(138, '159', NULL, NULL, '20', '160', 'PO-avbr9dik5917', 535, '174');
...
(37, 'บริษัท อ้วยอ้น จำกัด', '0643335168', 'auyaon@gmail.com'),
(38, 'บริษัท ซารา จำกัด', '0995699124', 'sara@gmail.co.th');
...
CREATE TABLE `partner_detail` (
  ...
  `partnerd_pro` varchar(300) NOT NULL,
  `partnerd_dis` varchar(300) NOT NULL,
  `partnerd_geo` varchar(300) NOT NULL,
  `partnerd_amp` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(70, '37', '11/5 ม.6', 'นครนายก', 'องครักษ์', '11239', 'เมือง'),
(71, '38', '356/7', 'เชียงใหม่', 'แม่ริม', '26590', 'แม่สรวย');
...
(158, 'PO-0o68ekrmb7ux', '2022-09-26', 'ei', '38', 'ได้รับสินค้า เข้าสต็อกแล้ว'),
(159, 'PO-avbr9dik5917', '2022-09-26', 'ei', '37', 'ได้รับสินค้า เข้าสต็อกแล้ว'),
(160, 'PO-avbr9dik5917', '2022-09-26', 'ei', '37', 'ได้รับสินค้า เข้าสต็อกแล้ว');
...
(154, '1', '154', NULL, NULL, '214', '158'),
(155, '30', '156', NULL, NULL, '481.5', '159'),
(156, '20', '159', NULL, NULL, '535', '160');
...
(152, 'สั่งซื้อสินค้าแล้ว รอใบรับสินค้า', '2022-09-26', 'PO-0o68ekrmb7ux'),
(153, 'สั่งซื้อสินค้าแล้ว รอใบรับสินค้า', '2022-09-26', 'PO-avbr9dik5917'),
(154, 'สั่งซื้อสินค้าแล้ว รอใบรับสินค้า', '2022-09-26', 'PO-avbr9dik5917');
...
(154, 'ซาร่า ยาแผง', NULL, '6', '110', '506', '9', '1664176042168696_1.jpg', 'WVNjExG1Ou'),
(156, 'ลีโอโพรวิดอน เบตาดีนล้า', NULL, '6', '110', '506', '9', '1664177984277355_1.jpg', '6SAODzmGw4'),
(157, 'กาวิสคอน รักษากรดไหลย้อน', NULL, '6', '110', '506', '9', '265306_1.jpg', 'z0OGn3wlub'),
(158, 'ที่ตรวจอุณหภูมิ', NULL, '6', '110', '506', '9', 'cs_270040.jpg', 'OPBIRKgj2k'),
(159, 'ยาแก้ไอ สำหรับเด็ก อ้วยอันโอสถ', NULL, '6', '110', '506', '9', '1664178061238244-1.png', 'ISPA4BCtXj');
...
(561, '2022-09-26', '2025-09-26', '2022-09-26', '154', 'Zs3F6QEwxw'),
(562, '2022-09-26', '2025-09-26', '2022-09-26', '156', 'vWhlTmVAIh'),
(563, '2022-09-07', '2022-12-06', '2022-09-26', '159', 'vWhlTmVAIh');
...
(1083, '1', 'Zs3F6QEwxw', '154'),
(1085, '29', 'vWhlTmVAIh', '156'),
(1086, '0', NULL, '157'),
(1087, '0', NULL, '158'),
(1088, '19', 'vWhlTmVAIh', '159');
...
(72, 'ubNkfRDpwy', '26', '500', '1', '230', '253.9', '2022-09-26 , 14:37:52', '154'),
(73, 'uHBrVYZAS1', '25', '60', '1', '30', '6.5', '2022-09-27 , 15:31:50', '159'),
(74, 'uHBrVYZAS1', '25', '60', '1', '20', '6.5', '2022-09-27 , 15:31:50', '156');
...
,`partnerd_pro` varchar(300)
,`partnerd_dis` varchar(300)
,`partnerd_geo` varchar(300)
,`partnerd_amp` varchar(300)
);
...
--
-- Stand-in structure for view `view_product_stockv3`
-- (See below for the actual view)
--
CREATE TABLE `view_product_stockv3` (
`product_id` int(11)
,`product_name` varchar(300)
,`product_img` varchar(300)
,`type_name` varchar(300)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_stockv2`  AS SELECT `a`.`product_id` AS `product_id`, `a`.`product_name` AS `product_name`, `a`.`product_img` AS `product_img`, `a`.`product_quantity` AS `product_quantity`, `a`.`good_Refno` AS `good_Refno`, `b`.`product_price_cost` AS `product_price_cost`, `b`.`product_price_sell` AS `product_price_sell`, `c`.`type_name` AS `type_name`, `c`.`unit_name` AS `unit_name`, `c`.`category_name` AS `category_name`, `c`.`symp_name` AS `symp_name`, `d`.`product_start_date` AS `product_start_date`, `d`.`product_end_date` AS `product_end_date` FROM (((`view_product_quantity` `a` left join `view_product_price` `b` on(`a`.`product_id` = `b`.`product_id`)) left join `view_product_detail` `c` on(`a`.`product_id` = `b`.`product_id`)) left join `view_product_date` `d` on(`a`.`product_id` = `d`.`product_id`)) WHERE `b`.`product_price_cost` <> 0 AND `a`.`good_Refno` is not nullnot null  ;

-- --------------------------------------------------------

--
-- Structure for view `view_product_stockv3`
--
DROP TABLE IF EXISTS `view_product_stockv3`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product_stockv3`  AS SELECT `a`.`product_id` AS `product_id`, `a`.`product_name` AS `product_name`, `a`.`product_img` AS `product_img`, `a`.`type_name` AS `type_name`, `a`.`type_id` AS `type_id`, `a`.`unit_id` AS `unit_id`, `a`.`unit_name` AS `unit_name`, `b`.`product_quantity` AS `product_quantity`, `c`.`product_price_cost` AS `product_price_cost`, `c`.`product_price_sell` AS `product_price_sell`, `d`.`product_start_date` AS `product_start_date`, `d`.`product_end_date` AS `product_end_date` FROM (((`view_product_detail` `a` left join `view_product_quantity` `b` on(`a`.`product_id` = `b`.`product_id`)) left join `view_product_price` `c` on(`a`.`product_id` = `c`.`product_id`)) left join `view_product_date` `d` on(`a`.`product_id` = `d`.`product_id`)) WHERE `d`.`product_start_date` <> ''''  ;
...
ALTER TABLE `customer_history`
  ADD PRIMARY KEY (`customer_his_id`);
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=536;
...
--
ALTER TABLE `customer_history`
  MODIFY `customer_his_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61122426;
...
--
ALTER TABLE `good`
  MODIFY `good_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;

--
-- AUTO_INCREMENT for table `good_detail`
--
ALTER TABLE `good_detail`
  MODIFY `good_detail_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `partner`
  MODIFY `partner_id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `partner_detail`
--
ALTER TABLE `partner_detail`
  MODIFY `partnerd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `po`
--
ALTER TABLE `po`
  MODIFY `po_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT for table `po_detailproduct`
--
ALTER TABLE `po_detailproduct`
  MODIFY `po_detailproid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;

--
-- AUTO_INCREMENT for table `po_status`
--
ALTER TABLE `po_status`
  MODIFY `po_status_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
...
--
ALTER TABLE `product_date`
  MODIFY `product_date_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=564;

--
-- AUTO_INCREMENT for table `product_price`
--
ALTER TABLE `product_price`
  MODIFY `product_price_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=287;

--
-- AUTO_INCREMENT for table `product_quantity`
--
ALTER TABLE `product_quantity`
  MODIFY `product_quantity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1089;
...
--
ALTER TABLE `reorder`
  MODIFY `reorder_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `type_product`
  MODIFY `type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
