...
<div class="row">
    <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="panel panel-back noti-box">
            ...
            <div class="text-box">
                <p class="main-text">สต็อก</p>
                <p class="text-muted"><?= $result_stock['count_stock'] ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="panel panel-back noti-box">
            ...
            <div class="text-box">
                <p class="main-text">ใบสั่งซื้อ</p>
                <p class="text-muted"><?= $result_po['count_po'] ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="panel panel-back noti-box">
            ...
            <div class="text-box">
                <p class="main-text">แจ้งเตือน</p>
                <p class="text-muted"></p>
                <a href="function_notify.php">แจ้งผล</a>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-6">
