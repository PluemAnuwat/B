...
function AnchorJS(A) {
  ...
  (this.options = A || {}),
    ...
    (this.add = function (A) {
      ...
      if (
        (e(this.options),
        (Q = this.options.visible),
        "touch" === Q && (Q = this.isTouchDevice() ? "always" : "hover"),
      ...
      for (
        ...
        if (this.hasAnchorJSLink(o[r])) f.push(r);
        else {
          if (o[r].hasAttribute("id")) a = o[r].getAttribute("id");
          else {
            (h = this.urlify(o[r].textContent)), (g = h), (l = 0);
            do void 0 !== c && (g = h + "-" + l), (c = s.indexOf(g)), (l += 1);
            while (-1 !== c);
            (c = void 0), s.push(g), o[r].setAttribute("id", g), (a = g);
          }
          (u = a.replace(/-/g, " ")),
            (B = document.createElement("a")),
            (B.className = "anchorjs-link " + this.options.class),
            (B.href = "#" + a),
            B.setAttribute("aria-label", "Anchor link for: " + u),
            B.setAttribute("data-anchorjs-icon", this.options.icon),
            "always" === Q && (B.style.opacity = "1"),
            "" === this.options.icon &&
      ...
      for (r = 0; r < f.length; r++) o.splice(f[r] - r, 1);
