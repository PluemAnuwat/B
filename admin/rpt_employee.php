<?php require 'rpt_detailsql_employee.php' ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <table width="704" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td width="291" align="center"><span class="style2">รายการผู้ใช้งานระบบ</span></td>
        ...
        <table bordercolor="#424242" width="800" height="78" border="1" align="center" cellspacing="0" class="style3">
            <tr align="center">
                ...
                <td width="178" align="center" bgcolor="#D5D5D5"><strong>ตำแหน่ง</strong></td>
            ...
            <?php while ($result = mysqli_fetch_assoc($query)) { ?>
                <tr class="text-center">
                    ...
                    <td align="left" class="style3"><?= $result['employee_name'] ?></td>
                    <td align="right" class="style3"><?= $result['employee_email'] ?></td>
                    <td align="right" class="style3"><?= $result['employee_role'] ?></td>
                    <td align="right" class="style3"><?= $result['employee_phone'] ?></td>
                </tr>
                <tr>
                            <?php } ?>
                </tr>
