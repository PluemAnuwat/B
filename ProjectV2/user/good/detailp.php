...
if (isset($_GET['good_RefNo']) && !empty($_GET['good_RefNo'])) {
     ...
     FROM goods a join goods_detailproduct aa ON a.good_id = aa.good_id JOIN product b ON aa.product_id = b.product_id 
...
<div class="card">
    <div class="card-body">
        ...
        <center>
            <h3>รายการใบรับสินค้า หมายเลข : <?php echo $good_RefNo ?> </h3>
        </center>
