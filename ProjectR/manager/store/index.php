     ...
     <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="show" name="sales_get" class="form-control text-right text-red" style="font-size:50px;">
                
                <select type="text" class="form-control" name="customer_id">
                    <?php
                $sqlunit = "SELECT * FROM customer";
                            ...
                            <center>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="btn btn-secondary mt-2" style="width:20%;height:20%;font-size:40px;"
                                        ...
                                        <button type="submit" class="btn mt-2 btncolor"  name="submit" value="submit" style="width:20%;height:20%;font-size:40px;">
