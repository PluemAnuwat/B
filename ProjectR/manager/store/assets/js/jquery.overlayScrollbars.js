    ...
    var PLUGIN = (function () {
            ...
            var checkObjectProps = function (
              ...
              for (var prop in template) {
                if (
                  ...
                  var templateTypes =
                    COMPATIBILITY.type(templateValue) != TYPES.a
                      ? [templateValue]
                      : templateValue;
                  ...
                  if (templateIsComplext && dataValueType == TYPES.o) {
                    ...
                    if (FRAMEWORK.isEmptyObject(dataValue)) delete data[prop];
                    ...
                    for (i = 0; i < templateTypes.length; i++) {
                      ...
                      isRestrictedValue =
                        ...
                        FRAMEWORK.inArray(currType, possibleTemplateTypes) ===
                          -1;
                      if (isRestrictedValue) {
                        ...
                        for (
                          v = 0;
                          v < restrictedStringValuesSplit.length;
                          v++
                        ) {
                          ...
                          for (
                            j = 0;
                            j < restrictedStringValuesPossibilitiesSplit.length;
                            j++
                          ) {
                    ...
                    if (isValid) {
                      validatedOptions[prop] =
                        isRestrictedValue && usePreparedValues
                          ? mainPossibility
                          : dataValue;
                    } else if (writeErrors) {
                      console.warn(
      ...
      function OverlayScrollbarsGlobals(defaultOptions) {
        ...
        function detectCSSFeature(featurename) {
          ...
          if (elm[LEXICON.s][featurename] !== undefined) feature = true;
          ...
          if (!feature) {
            ...
            for (; i < domPrefixes.length; i++) {
              if (
                elm[LEXICON.s][domPrefixes[i] + featurenameCapital] !==
                undefined
              ) {
                feature = true;
                break;
      ...
      function OverlayScrollbarsInstance(
        ...
        function addResizeObserver(targetElement, onElementResizedCallback) {
          ...
          var callback = function () {
            targetElement[_strScrollTop](constMaximum)[_strScrollLeft](
              _isRTL
          ...
          if (_supportResizeObserver) {
            var element = targetElement
              .append(
                generateDiv(_classNameResizeObserverElement + " observed")
              )
              .contents()[0];
            ...
            if (_msieVersion > 9 || !_autoUpdateRecommended) {
              targetElement.prepend(
                generateDiv(
                  ...
                  generateDiv(
                    {
                      className: _classNameResizeObserverItemElement,
                      dir: "ltr",
                    },
                    generateDiv(
              ...
              var reset = function () {
                /*
                                 ...
                                 */
                expandElement[_strScrollLeft](constMaximum)[_strScrollTop](
                  constMaximum
                );
                shrinkElement[_strScrollLeft](constMaximum)[_strScrollTop](
                  constMaximum
                );
              };
          ...
          if (targetElement[0] === _sizeObserverElement[0]) {
            var directionChanged = function () {
              ...
              if (dir !== _cssDirectionDetectedCache) {
                ...
                targetElement[_strScrollLeft](scrollLeftValue)[_strScrollTop](
                  constMaximum
                );
        ...
        function createMutationObservers() {
          if (_supportMutationObserver) {
            ...
            _mutationObserverContent = new mutationObserver(function (
              mutations
            ) {
              if (!_initialized || _isSleeping) return;
        ...
        function connectMutationObservers() {
          if (_supportMutationObserver && !_mutationObserversConnected) {
            ...
            _mutationObserverContent.observe(
              _isTextarea ? _targetElement[0] : _contentElement[0],
              {
                attributes: true,
                attributeOldValue: true,
                subtree: !_isTextarea,
        ...
        function setupHostMouseTouchEvents(destroy) {
          ...
          var setupEvent = function (target, name, listener) {
            if (_supportPassiveEvents) passiveEvent(target, name, listener);
        ...
        function update(
          ...
          contentSizeChanged =
            contentSizeChanged === undefined ? false : contentSizeChanged;
          ...
          var resizeChanged =
            checkCacheSingle(resize, _resizeCache, force) && !_isBody; //body can't be resized since the window itself acts as resize possibility.
          ...
          var border = {
            ...
            b: updateBorderY
              ? parseToZeroOrNumber(
                  _hostElement.css(
                    _strBorderMinus + _strBottom + strMinusWidth
                  ),
                  true
                )
              : 0,
          ...
          if (
            ...
            if (cssMaxValue.cw)
              contentElementCSS[_strMaxMinus + _strHeight] = cssMaxValue.ch
                ? cssMaxValue.ih -
                  padding.ay +
          ...
          if (
            ...
            if (cssMaxValue.cw)
              contentElementCSS[_strMaxMinus + _strWidth] = cssMaxValue.cw
                ? cssMaxValue.iw -
                  padding.ax +
          ...
          if (widthAuto) {
            ...
            contentGlueElementCSS[_strWidth] =
              _isTextarea && textareaDynWidth ? textareaSize.dw : _strAuto;
          ...
          if (
            ...
            var contentClientSize = {
              w:
                _isTextarea && textareaSize && !textareaDynWidth
                  ...
                  : scrollSize.w,
              h:
                _isTextarea && textareaSize && !textareaDynHeight
                  ? textareaSize.oh
                  : heightAuto
                  ? clientSize.h
                  : scrollSize.h,
            ...
            if (sizeAutoCapable) {
              ...
              if (widthAuto && cssMaxValue.cw && cssMaxValue.iw === maxWidth)
                contentGlueElementCSS[_strWidth] =
                  maxWidth + (_isBorderBox ? 0 : _paddingX) + 1;
              if (heightAuto && cssMaxValue.ch && cssMaxValue.ih === maxHeight)
                contentGlueElementCSS[_strHeight] =
                  maxHeight + (_isBorderBox ? 0 : _paddingY) + 1;
              ...
              if (
                ...
                if (_isTextarea)
                  textareaCoverCSS[_strWidth] =
                    parseToZeroOrNumber(_textareaCoverElement.css(_strWidth)) -
                    1;
                contentGlueElementCSS[_strWidth] -= 1;
              }
              if (
                heightAuto &&
                (clientSize.h < _viewportSize.h || _isTextarea) &&
                _paddingY === 0
              ) {
                if (_isTextarea)
                  textareaCoverCSS[_strHeight] =
                    parseToZeroOrNumber(_textareaCoverElement.css(_strHeight)) -
                    1;
            ...
            contentScrollSize.c = contentSizeChanged = checkCacheDouble(
              contentScrollSize,
            ...
            var overflowAmount = {
              x: MATH.max(
                0,
                MATH.round((contentScrollSize.w - _viewportSize.w) * 100) / 100
              ),
              y: MATH.max(
                0,
                MATH.round((contentScrollSize.h - _viewportSize.h) * 100) / 100
              ),
            };
            ...
            if (_nativeScrollbarIsOverlaid.x || _nativeScrollbarIsOverlaid.y) {
              ...
              if (
                ...
                if (
                  ...
                  contentElementCSS[_strMarginMinus + _strBottom] = heightAuto
                    ? ignoreOverlayScrollbarHiding
                      ? _strEmpty
                      : _overlayScrollbarDummySize.x
                    : _strEmpty;
                  contentElementCSS[_strBorderMinus + _strBottom] =
                    !heightAuto && !ignoreOverlayScrollbarHiding
                      ? _overlayScrollbarDummySize.x + borderDesign
                      : _strEmpty;
                } else {
                  arrangeContent.h =
                ...
                if (
                  ...
                  contentElementCSS[_strMarginMinus + isRTLLeft] = widthAuto
                    ? ignoreOverlayScrollbarHiding
                      ? _strEmpty
                      : _overlayScrollbarDummySize.y
                    : _strEmpty;
                  contentElementCSS[_strBorderMinus + isRTLLeft] =
                    /* !widthAuto && */ !ignoreOverlayScrollbarHiding
                      ? _overlayScrollbarDummySize.y + borderDesign
                      : _strEmpty;
                } else {
                  arrangeContent.w =
            ...
            if (
                ...
                if (!ignoreOverlayScrollbarHiding) {
                  viewportElementCSS[_strBottom] =
                    -(_nativeScrollbarIsOverlaid.x
                      ? _overlayScrollbarDummySize.x
                      : _nativeScrollbarSize.x);
                  _contentBorderSize.h = _nativeScrollbarIsOverlaid.x
                    ? _overlayScrollbarDummySize.y
                    : 0;
              ...
              if (hasOverflow.y && hideOverflow.ys) {
                ...
                if (!ignoreOverlayScrollbarHiding) {
                  viewportElementCSS[isRTLLeft] = -(_nativeScrollbarIsOverlaid.y
                    ? _overlayScrollbarDummySize.y
                    : _nativeScrollbarSize.y);
                  _contentBorderSize.w = _nativeScrollbarIsOverlaid.y
                    ? _overlayScrollbarDummySize.x
                    : 0;
              ...
              if (textareaInfo) {
                var textareaRowsChanged =
                  _textareaInfoCache === undefined
                    ? true
                    : textareaInfo.rows !== _textareaInfoCache.rows;
                      ...
                      ? cursorIsLastPosition ||
                        (textareaRowsChanged &&
                          (previousOverflow !== undefined
                            ? currScroll.t === previousOverflow.y
                            : false))
            ...
            if (!textareaScrollY) _viewportElement[_strScrollTop](currScroll.t);
        ...
        function setOptions(newOptions) {
          ...
          _currentPreparedOptions = extend(
            ...
            _pluginsOptions.v(newOptions, _pluginsOptions.t, false, true)
          );
        }
        ...
        function setupStructureDOM(destroy) {
          ...
          var applyAdoptedAttrs = function () {
            ...
            FRAMEWORK.each(adoptAttrsMap, function (k, v) {
              if (type(v) == TYPES.s) {
                if (k == LEXICON.c) applyAdoptedAttrsElm.addClass(v);
          ...
          adoptAttrs =
            type(adoptAttrs) == TYPES.s ? adoptAttrs.split(" ") : adoptAttrs;
          ...
          if (!destroy) {
            if (_isTextarea) {
              ...
              _isTextareaHostGenerated = !(
                parent.hasClass(_classNameHostTextareaElement) &&
              ...
              _hostElement
                ...
                .wrapInner(
                  generateDiv(
                    _classNameContentElement + _strSpace + _classNameTextInherit
                  )
                )
                .wrapInner(
                  generateDiv(
                ...
                .wrapInner(
                  generateDiv(
                    _classNamePaddingElement + _strSpace + _classNameTextInherit
                  )
                );
        ...
        function setupStructureEvents(destroy) {
          ...
          if (!destroy && _isTextarea) {
            ...
            updateTextarea = function (doClearInterval) {
              ...
              if (doClearInterval) clearInterval(textareaUpdateIntervalID);
            };
            ...
            if (_msieVersion > 9 || !_autoUpdateRecommended) {
              ...
              _textareaEvents[_strKeyDownEvent] = function textareaOnKeyDown(
                event
              ) {
                ...
                if (
                  FRAMEWORK.inArray(keyCode, textareaKeyDownKeyCodesList) === -1
                )
              ...
              _textareaEvents[_strKeyUpEvent] = function (event) {
                ...
                if (!textareaKeyDownKeyCodesList.length) updateTextarea(true);
              };
            }
          }
        ...
        function setupScrollbarsDOM(destroy) {
          if (!destroy) {
            _scrollbarHorizontalElement = FRAMEWORK(
              generateDiv(
                _classNameScrollbar + _strSpace + _classNameScrollbarHorizontal
              )
            );
            ...
            _scrollbarVerticalElement = FRAMEWORK(
              generateDiv(
                _classNameScrollbar + _strSpace + _classNameScrollbarVertical
              )
            );
        ...
        function setupScrollbarEvents(isHorizontal) {
            ...
            if (onMouseTouchDownContinue(event)) {
              ...
              var scrollRaw =
                (_msieVersion && insideIFrame
                  ? event["screen" + XY]
                  : COMPATIBILITY.page(event)[xy]) - mouseDownOffset; //use screen coordinates in EDGE & IE because the page values are incorrect in frames.
          ...
          scrollbarVars.h.on(_strMouseTouchDownEvent, function (event) {
            if (onMouseTouchDownContinue(event)) onHandleMouseTouchDown(event);
          });
          scrollbarVars.t
        ...
        function refreshScrollbarHandleOffset(isHorizontal, currentScroll) {
          ...
          if (_rtlScrollBehavior.n && isRTLisHorizontal) maxScroll *= -1;
        ...
        function setupScrollbarCornerEvents() {
          ...
          _resizeOnMouseTouchDown = function (event) {
            if (onMouseTouchDownContinue(event)) {
              ...
              resizeDragStartSize.w =
                _hostElement[0][LEXICON.oW] - (!_isBorderBox ? _paddingX : 0);
              resizeDragStartSize.h =
                _hostElement[0][LEXICON.oH] - (!_isBorderBox ? _paddingY : 0);
          ...
          function documentMouseTouchUp(event) {
            ...
            if (eventIsTrusted) {
              if (_resizeReconnectMutationObserver) connectMutationObservers();
              _base.update(_strAuto);
            }
        ...
        _base.scroll = function (coordinates, duration, easing, complete) {
          ...
          var getRawScroll = function (isX, coordinates) {
            ...
            if (type(coordinates) == TYPES.a)
              ...
              normalizeRTL =
                type(coordinates.n) == TYPES.b ? coordinates.n : normalizeRTL;
          ...
          var getFinalScroll = function (isX, rawScroll) {
            ...
            if (isString) {
              ...
              rawScroll =
                operator !== undefined ? rawScroll.substr(2) : rawScroll;
            ...
            if (_isRTL) {
              ...
              if (_rtlScrollBehavior.i && normalizeRTL)
                elementScrollCoordinates.x = MATH.round(
                  viewportOffset[_strLeft] -
                    elementOffset[_strLeft] +
                    (_scrollHorizontalInfo.ms - viewportScroll.l)
                );
            }
        ...
        _base.ext = function (extName) {
          ...
          if (type(extName) == TYPES.s) {
            ...
            result = {};
            for (i in _extensions) result[i] = extend(true, {}, _base.ext(i));
          }
          return result;
        };
        ...
        function construct(targetElement, options, extensions) {
          ...
          _windowElement = FRAMEWORK(
            _documentElement[0].defaultView || _documentElement[0].parentWindow
          );
        ...
        if (pluginTargetElements.length > 0) {
          if (optsIsPlainObj) {
            ...
            FRAMEWORK.each(pluginTargetElements, function (i, v) {
              inst = INSTANCES(v);
              if (
                (options === "!" && inst instanceof window[PLUGINNAME]) ||
      ...
      window[PLUGINNAME].defaultOptions = function (newDefaultOptions) {
        ...
        _pluginsGlobals.defaultOptions = FRAMEWORK.extend(
          ...
          {},
          currDefaultOptions,
          _pluginsOptions.v(newDefaultOptions, _pluginsOptions.t, true)
        );
      };
