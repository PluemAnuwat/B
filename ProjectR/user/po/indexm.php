...
<?php $sql ="SELECT * FROM po a JOIN po_detailproduct b ON a.po_id = b.po_id group by a.po_id ASC";
...
<br>
    ...
    { ?>
        <tr>
            ...
            <?php $sql = "SELECT  * FROM po a JOIN po_detailproduct b ON a.po_id = b.po_id WHERE a.po_id = '".$row['po_id']."'";
