                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="..\unpaid\index.php"> UNPAID</a>
                                </li>
                                <li class="nav-item">
              ...
              ?>
                               ...
                               $sql ="SELECT *
                                FROM akksofttech_purchase_order 
                                  WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' ORDER BY 	po_start_date " ;
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col" align="left">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <a
                                                                                    class="form-subhead"><?php echo number_format($row2['prod_price'],0,'.',',');?></a>
                                                                                <br>
                                                                                <a class="form-input">
                                                                                    <font color="red">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <a class="form-subhead"><?php echo $row2['sprod_name'];?>
                                                                                    ...
                                                                                    <a class="form-subhead"><?php echo number_format($row2['prod_price'],0,'.',',');?>
                                                                                    </a>
                                                                                    <br>
