            ...
            <div class="container-xxl flex-grow-1 container-p-y">
               ...
               <div class="row">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="..\completed\index.php"
                        > COMPLETED</a
                      >
                    </li>
                  </ul>
                ...
                <div class="col">
                  <div class="card mb-4">
                    ...
                    <?php
                      ...
                      WHERE sto_id = '".$_SESSION['akksofttechsess_stoid']."' AND po_status = 2" ;
...
<img src="../getimg/prod/<?php echo $row2['prod_image'];?>" height="150px;" width="130px;">

<?php }else if($row2['sprod_id'] != 0  && $row2['sprodone_id'] == 0){ ?>

<img src="../getimg/sprod/<?php echo $row2['prod_image'];?>" height="150px;" width="130px;">

<?php }else if($row2['sprod_id'] != 0 && $row2['sprodone_id'] != 0 ){ ?>

<img src="../getimg/sprodone/<?php echo $row2['prod_image'];?>" height="150px;" width="130px;">
          ...
          <?php }else if($row2['sprod_id'] != 0 && $row2['sprodone_id'] != 0 ){ ?>
            ...
            <?php } ?>
                              ...
                              <?php }   ?>
                                       ...
                                       <td style="text-align:center;">
                                        <?php echo "<span class='badge bg-label-primary me-1'>TO CONFIRM</span>";?>
                                      </td>
