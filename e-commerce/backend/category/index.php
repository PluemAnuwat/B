               ...
               <div class="row">
                  <div class="col-md-12">
                     <ul class="nav nav-pills flex-column flex-md-row mb-3">
                        <li class="nav-item">
                           <a type=" button" class="nav-link active" id="btn-add" href="add_form.php"><i class="bx bx-plus"></i> ADD CATEGORY</a>                                                                    
                        </li>
                        <li class="nav-item">
                           <a type=" button" class="nav-link active" id="btn-view" href="#"><i class="bx bx-show-alt"></i> VIEW CATEGORY</a>                                                                    
                        </li>
                     </ul>
                     <div class="card mb-4">
                              ...
                              <table class="table table-borderless" id="myTable">
                                 ...
                                 <tbody id="mysfutton">
                                    ...
                                    <tr>
                                       ...
                                       <td style="text-align:center;"><img src="../getimg/cate/<?php echo $row['cat_img']; ?>"></td>
