...
<body>
    ...
    *:after {
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 form-input form">
                                                            <input type="text" autocomplete="off" required name="bac_number"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 form-input form">
                                                            <input type="text" autocomplete="off" required name="bac_account"
                                                                oninvalid="this.setCustomValidity('Please Transfer Bank Number')"
                                                                oninput="this.setCustomValidity('')"
    ...
    <script type="text/javascript" src="serve/serve.bank.js"></script>
