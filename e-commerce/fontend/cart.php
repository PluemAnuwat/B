...
<body>
    ...
    <section class="checkout-wrapper pt-50 m-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="product-cart d-flex m-2">
                                                    ...
                                                    <div class="product-content media-body m-2">
                                                        ...
                                                        <h5 class="title"><a href="product-details-page.html"
                                                                class="text-dark">
                                            ...
                                            <td>
                                                ...
                                                <div id="show_price1" class="price m-3"><?php echo number_format($r['prod_price_simple'],2,'.',',') ; ?></div>
                                            ...
                                            <td>
                                                ...
                                                <div class="product-quantity d-inline-flex m-2 ">
                                                    ...
                                                    <button type="button" id="show_molo_minus1"  data-id='<?php echo $r['cart_id'] ; ?>'
                                                        class="show_molo_minus1"><i class="mdi mdi-minus"></i></button>

                                                    <button id="show_quantity1<?php echo $r['cart_id'] ; ?>" data-id='<?php echo $r['cart_id'] ; ?>'><?php echo $r['quantity'] ; ?></button>

                                                    <button type="button" id="show_molo_plus1" data-id='<?php echo $r['cart_id'] ; ?>'
                                            ...
                                            <td>
                                                <p class="price m-3">
                                                    ...
                                                    <div id="show_price_qty<?php echo $r['cart_id'] ; ?>"><?php echo  number_format($r['prod_price_simple'] * $r['quantity'],2,'.',',') ; ?></div>
                                            ...
                                            <td>
                                                <ul class="action m-3">
                                                    <!-- <li><a class="delete delete_cart" href="javascript:void(0)"><i
                                                                ...
                                                                <li>      <a type="button" 
                                                        class="delete delete_cart" data-id='<?php echo $r['cart_id'] ; ?>'><i class="mdi mdi-delete"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
