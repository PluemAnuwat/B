                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-details-content mt-45">
                            ...
                            <div class="product-items flex-wrap">
                                ...
                                <div id="boxshowsubproductionselect">
                                    ...
                                    <div id="boxshowsubproductionid">
                                        ...
                                        <h6 class="item-title"> Select Your :
                                            <?php echo $r['prod_name'] ; ?> </h6>
                            ...
                            <div class="product-price ">
                                ...
                                INNER JOIN akksofttech_product ON akksofttech_member_store.sto_id = akksofttech_product.sto_id" ; 
                               
                               $que = mysqli_query($conn , $sql); 
                                
                               $res_sto = mysqli_fetch_array($que); ?>

                                <h6 class="price-title"><?php echo $res_sto['sto_name'] ;?></h6>
                            ...
                            <div class="product-btn">
                                ...
                                <button href="javascript:void(0)" class="main-btn primary-btn addtocart"
                                    id="ok_inset_cart">
