$(document).ready(function () {
  ...
  $("#show_molo_plus").click(function () {
    ...
    $("#showpriceall").html() * (quantity * 1 + 1)  ;
      ...
      success: function (data) {
        ...
        $.each(data, function (key, val) {
          ...
          if (val["status"] == "NO") {
            ...
            $htmlss += '  <p class="sale-price">' + prod_price * prod_quantity + "</p>";

            $("#showpriceall").html(prod_price * prod_quantity );
    ...
    function ViewshowproductNo() {
      ...
      function ViewshowproductYes() {
        console.log("-------------------------ไม่ซ่อนสินค้าย่อยเนื่องจากมีสินค้าย่อย 1 " );
      ...
      success: function (data) {
        ...
        $.each(data, function (key, val) {
          ...
          if (val["status"] == "NO 1") {
            ...
            $htmlss += '   <p class="sale-price"> $ ' + sprod_price * sprod_quantity + "</p>";

            $("#showpriceall").html(sprod_price * sprod_quantity );
            ...
            $htmlsss +=
              '  <li class="active" style="width:80px;" id="show_sprodone_id" sprodone_id="' +
              sprodone_id + '">'+
              sprodone_name +
              "</div></li>";
  ...
  $("#boxshowsubproductionselectone").on( "click", "#show_sprodone_id", function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $.each(data, function (key, val) {
            ...
            $htmlss += '  <p class="h1">' + sprodone_price * sprodone_quantity + "</p>";

            $("#showpriceall").html(sprodone_price * sprodone_quantity );
        ...
        $.each(data, function (key, val) {
          ...
          if(val['status'] == "NOLOGIN") {
            ...
            Swal.fire({
              position: 'center',
              icon: 'success',
              title: 'UPDATE TO CART (NOT SUBPRODUCT)',
              showConfirmButton: false,
              timer: 1500
            })
            ...
            Swal.fire({
              position: 'center',
              icon: 'error',
              title: 'UPDATE TO CART ERROR (NOT SUBPRODUCT)',
              showConfirmButton: false,
              timer: 1500
            })
            ...
            Swal.fire({
              ...
              // window.location.href='detail.php?prod_id=' + show_prod_id  ;  
              ...
              Swal.fire({
                ...
                Swal.fire({
                  position: 'center',
                  icon: 'success',
                  title: 'UPDATE TO CART (NOT SUBPRODUCT1)',
                  showConfirmButton: false,
                  timer: 1500
                })
                ...
                Swal.fire({
                  position: 'center',
                  icon: 'error',
                  title: 'UPDATE TO CART ERROR (NOT SUBPRODUCT1)',
                  showConfirmButton: false,
                  timer: 1500
                })
  ...
  function changecart(){
    ...
    $.ajax({
      ...
      url: "serve/change_product_cart.php",
