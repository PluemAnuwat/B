...
<body>
    ...
    <?php  $sss = "SELECT * FROM akksofttech_cart INNER JOIN akksofttech_member_store 
                ...
                $nnn = mysqli_num_rows($qqq) ; 
                $rrr = mysqli_fetch_array($qqq);               
                
                if($nnn == 0){ 
                  
                    echo '<div id="show_cart_id" style="display:none;">0</div>' ;  

                }
                ?>

    <div id="show_address_id" >0</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <a class="main-btn primary-btn" id="clickshowselectmodaladdress">SELECT
                                                    ADDRESS</a>
